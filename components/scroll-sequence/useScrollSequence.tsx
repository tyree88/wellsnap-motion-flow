...
export const useScrollSequence = (sections: ScrollSequenceSection[], lenisInstance?: any) => {
  ...
  useEffect(() => {
    ...
    // Integrate with Lenis smooth scrolling if available
    if (lenisInstance) {
  ...
  }, [sections, prefersReducedMotion, lenisInstance])
  ...
  return { refs, prefersReducedMotion, currentSectionIndex }
}
